...
const Hero = () => {
  return <section className="relative min-h-[100dvh] flex items-center justify-center hero-gradient overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[100vw] flex flex-col items-center justify-center gap-3 sm:gap-4 md:gap-6 text-center px-4 py-8 sm:py-12 md:py-16 sm:px-0 mx-[3px] lg:py-[25px] rounded-full">
        ...
        <p className="w-full break-words text-xs sm:text-sm md:text-lg lg:text-xl text-white/90 leading-relaxed max-w-[90vw] sm:max-w-md md:max-w-2xl text-center font-light px-0 py-[64px] my-[37px] mx-[38px] xl:text-3xl">Building global ventures at the intersection of  
