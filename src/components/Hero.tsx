...
const Hero = () => {
  return <section className="relative min-h-[100dvh] flex items-center justify-center hero-gradient overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[100vw] flex flex-col items-center justify-center gap-3 sm:gap-4 md:gap-6 text-center px-4 sm:px-6 py-8 sm:py-12 md:py-16 lg:py-20">
        ...
        <h1 className="w-full text-xl sm:text-2xl md:text-4xl lg:text-5xl text-white/80 font-semibold leading-tight px-2 xl:text-4xl">
          Transforming Digital Landscapes
        </h1>
        <p className="w-full mx-auto break-words text-xs sm:text-sm md:text-lg lg:text-xl text-white/90 leading-relaxed max-w-[90vw] sm:max-w-md md:max-w-2xl px-[28px] py-[40px] text-center font-semibold xl:text-sm">
