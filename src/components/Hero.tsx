...
const Hero = () => {
 ...
 <p className="text-white/80 mb-1 mt-0 py-0 text-3xl font-normal mx-[2px] my-[4px] px-[34px]">
  Transforming Digital Landscapes
      </p>

      <p className="text-xl md:text-2xl text-white/90 leading-relaxed font-medium max-w-2xl mt-0 text-center mx-[4px] px-[49px] my-[8px]">
